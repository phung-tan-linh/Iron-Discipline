...
public:
    ...
    static void updateDailyUsageItem(const std::string &identifier, int usedSeconds);
    static void migrateDailyToHistory(const std::string&,const std::map<std::string,int>&);static void clearDailyUsage();
};
#endif